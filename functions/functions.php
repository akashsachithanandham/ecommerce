        ...
        echo "
                <div class='single_product'>
                    ...
                    <p> <b> Rs $pro_price/-  </b> </p>
                     <div class=\"form-row\">
                   <div class=\"col-3\"> <a class=\"text-white\" href='details.php?pro_id=$pro_id' style='float: left'>Details</a></div>
                    <div class=\"col-9\"><a  class=\"btn\"href='index.php?add_cart=$pro_id'><button style='float: right;'>Add to Cart</button></a></div></div>
                </div>
        ";
    }
}
